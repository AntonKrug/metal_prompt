...
extern unsigned int m_p_iterate_get_current_string(char *buf, const bool use_color);
...
extern void         m_p_iterate_align_with_longest_command(const unsigned int current_size);
#endif
